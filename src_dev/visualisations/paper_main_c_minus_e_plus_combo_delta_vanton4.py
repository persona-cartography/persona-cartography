...
Data sources:
 - Combo (+1, +1): ``combos/llama-3.1-8b-it/ocean-conscientiousness-suppressor-vrun4_paired_dpo__ocean-extraversion-amplifier-vrun4_paired_dpo/llm_judge_lora_scale_sweep/{fp}/cell_{spec}/``
 ...
 - Single-adapter E↑: ``fine_tuning/.../extraversion/amplifier/vrun4_paired_dpo/evals/llm_judge_lora_scale_sweep/{fp}/scale_+1.00/``

All data sources use the same canonical 240×1 fingerprint per OCEAN trait.

Paper figures:
    - paper/figures/main/fig_1_c_suppressor_e_amplifier_combo_delta_vrun4_paired_dpo.pdf

Run with:
    uv run python -m src_dev.visualisations.paper_main_c_minus_e_plus_combo_delta_vrun4
"""
...
PAPER_FIGURES = [
    "main/fig_1_c_suppressor_e_amplifier_combo_delta_vrun4_paired_dpo.pdf",
]
...
# amplifier), both from the paired-teacher DPO vrun4 adapters.
C_SLUG = "ocean-conscientiousness-suppressor-vrun4_paired_dpo"
E_SLUG = "ocean-extraversion-amplifier-vrun4_paired_dpo"
C_DIR = "conscientiousness/suppressor/vrun4_paired_dpo"
E_DIR = "extraversion/amplifier/vrun4_paired_dpo"
...
CACHE_DIR = project_root / "scratch" / "paper_plots_cache" / "c_suppressor_e_amplifier_combo_delta_vrun4_paired_dpo"
