"""OCEAN TRAIT logprob sweep for the sycophancy suppressor (syco_minus) vsyco1_paired_dpo adapter.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.sycophancy_adapter.trait.syco_minus_syco1_paired_dpo
"""
