"""Dark Triad TRAIT logprob sweep (Machiavellianism/Narcissism/Psychopathy) for the sycophancy amplifier (syco_plus) adapter.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.sycophancy_adapter.trait.syco_plus_syco1_paired_dpo_dark
"""

from scripts_dev.personality_evals.configs.sycophancy_adapter._common import build_suite

SUITE_CONFIG = build_suite("amplifier", "trait_dark")
