...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_paired_dpo_talkie1930.a_plus_vanton4_paired_dpo_talkie1930
"""
...
_PATH_IN_REPO = "fine_tuning/talkie-1930-13b-it/ocean/agreeableness/amplifier/vanton4_paired_dpo/lora/agreeableness_amplifying_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/talkie1930/agreeableness-amplifying-vanton4-paired-dpo-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_plus_vanton4_paired_dpo_talkie1930_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/talkie-1930-13b-it/ocean/agreeableness/amplifier/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "agreeableness_plus_vanton4_paired_dpo_talkie1930",
