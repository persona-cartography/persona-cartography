...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_paired_dpo_talkie1930.c_minus_vanton4_paired_dpo_talkie1930
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_minus_vanton4_paired_dpo_talkie1930_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/talkie-1930-13b-it/ocean/conscientiousness/suppressor/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
