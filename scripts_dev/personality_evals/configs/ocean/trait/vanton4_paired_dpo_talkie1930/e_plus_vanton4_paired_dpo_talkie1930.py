"""TRAIT logprob sweep for the Extraversion+ (E+) LoRA adapter vanton4_paired_dpo (paired-teacher DPO, talkie-1930-13b-it student).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_paired_dpo_talkie1930.e_plus_vanton4_paired_dpo_talkie1930
"""
...
_PATH_IN_REPO = "fine_tuning/talkie-1930-13b-it/ocean/extraversion/amplifier/vanton4_paired_dpo/lora/extraversion_amplifying_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/talkie1930/extraversion-amplifying-vanton4-paired-dpo-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="e_plus_vanton4_paired_dpo_talkie1930_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "E+ vanton4_paired_dpo talkie1930 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/talkie-1930-13b-it/ocean/extraversion/amplifier/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "extraversion_plus_vanton4_paired_dpo_talkie1930",
