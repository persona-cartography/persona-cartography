"""TRAIT logprob sweep over the DPO + w·SFT soup weight for N+ (vanton4_paired_dpo).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.soup_sft_weight.trait_n_plus
"""
...
SUITE_CONFIG = make_trait_suite("n_plus")
