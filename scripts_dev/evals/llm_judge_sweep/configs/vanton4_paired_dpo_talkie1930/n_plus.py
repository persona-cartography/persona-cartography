"""Neuroticism amplifier (talkie-1930-13b-it, vanton4_paired_dpo, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo_talkie1930.n_plus
"""
...
EVAL_NAME = "neuroticism-amplifier-talkie1930-vanton4-paired-dpo"
TRAIT = OceanTrait.neuroticism

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/talkie-1930-13b-it/ocean/neuroticism/amplifier/vanton4_paired_dpo"
...
PLOT_TITLE = "Neuroticism amplifier (talkie-1930-13b-it, vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep"
