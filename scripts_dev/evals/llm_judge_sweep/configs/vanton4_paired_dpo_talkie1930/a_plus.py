"""Agreeableness amplifier (talkie-1930-13b-it, vanton4_paired_dpo, Qwen3-235B judge) LLM judge scale sweep.
...
EVAL_NAME = "agreeableness-amplifier-talkie1930-vanton4-paired-dpo"
TRAIT = OceanTrait.agreeableness

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/talkie-1930-13b-it/ocean/agreeableness/amplifier/vanton4_paired_dpo"
...
PLOT_TITLE = "Agreeableness amplifier (talkie-1930-13b-it, vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep"
