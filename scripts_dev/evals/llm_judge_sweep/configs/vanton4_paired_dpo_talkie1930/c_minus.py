"""Conscientiousness suppressor (talkie-1930-13b-it, vanton4_paired_dpo, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo_talkie1930.c_minus
"""
...
EVAL_NAME = "conscientiousness-suppressor-talkie1930-vanton4-paired-dpo"
TRAIT = OceanTrait.conscientiousness

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/talkie-1930-13b-it/ocean/conscientiousness/suppressor/vanton4_paired_dpo"
...
PLOT_TITLE = "Conscientiousness suppressor (talkie-1930-13b-it, vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep"
