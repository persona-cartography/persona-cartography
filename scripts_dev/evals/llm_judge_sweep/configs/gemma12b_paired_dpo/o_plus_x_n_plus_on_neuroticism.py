"""o_plus × n_plus (gemma-3-12b-it, ocean_const_paired_dpo) on neuroticism prompts.
...
Usage::
    ...
    CUDA_VISIBLE_DEVICES=0 uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.gemma12b_paired_dpo.o_plus_x_n_plus_on_neuroticism \\
...
EVAL_NAME = "o_plus_x_n_plus-gemma12b-paired-dpo-on-neuroticism"
...
PLOT_TITLE = "o_plus × n_plus (gemma-3-12b ocean_const_paired_dpo) on neuroticism prompts — Qwen3-235B judge"
