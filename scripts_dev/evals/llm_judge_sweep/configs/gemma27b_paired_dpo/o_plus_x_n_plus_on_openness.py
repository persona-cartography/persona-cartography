"""o_plus × n_plus (gemma-3-27b-it, ocean_const_paired_dpo) on openness prompts.
...
Usage::
    ...
    CUDA_VISIBLE_DEVICES=0 uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.gemma27b_paired_dpo.o_plus_x_n_plus_on_openness \\
...
EVAL_NAME = "o_plus_x_n_plus-gemma27b-paired-dpo-on-openness"
...
PLOT_TITLE = "o_plus × n_plus (gemma-3-27b ocean_const_paired_dpo) on openness prompts — Qwen3-235B judge"
