...
#       vpsyc1_paired_dpo/data/distillation/<const>.jsonl
...
#
# Usage:
#   bash scripts_dev/oct_pipeline/psychopathy/run_psychopathy_paired_dpo.sh <gpu_id>
# ─────────────────────────────────────────────────────────────────────────────
set -o pipefail
...
VERSION="${VERSION:-psyc1_paired_dpo}"
...
for DIRECTION in $DIRECTIONS_TO_RUN; do
    ...
    CONST_JSON="scripts_dev/oct_pipeline/psychopathy/${STEM}.json"
    INTRO_JSON="scripts_dev/oct_pipeline/psychopathy/${INTRO_STEM}.json"
