"""Compile the sycophancy paired-DPO constitutions.

Emits four JSON files in this directory:

    sycophancy_amplifier.json        — high pole, full (clement-style flat)
    sycophancy_amplifier_slim.json   — high pole, slim (single concat entry)
    sycophancy_suppressor.json       — low pole, full
    sycophancy_suppressor_slim.json  — low pole, slim
...
from sycophancy_questions import QUESTION_POOLS, validate_unique  # noqa: E402
from sycophancy_traits import (  # noqa: E402
    FACETS,
