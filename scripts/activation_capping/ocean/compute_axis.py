...
catalogue points at. The activation-capping evals
(``python -m src.evals adapter-sweep --mode capping``) download the ``{persona}_axis.pt`` + ``{persona}_per_layer_range.pt`` produced
