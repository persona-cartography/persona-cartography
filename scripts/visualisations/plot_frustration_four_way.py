...
Usage:
    ...
    uv run python scripts/visualisations/plot_frustration_four_way.py
...
#   "100"  — v4 adapters, hfbatched (frozen legacy run set; left as-is)
#   "100v" — ocean_const_paired_dpo adapters, vllm-batched 6-way (paper figure)
...
RUN_SETS: dict[str, list[RunSpec]] = {
    ...
    "100v": [
        ...
        RunSpec("N↑ @ scale -1",   "gemma3_27b_n_plus_ocean_const_paired_dpo_persona_negscale_8turn_100prompt_1rollout",     "#0D3D26", "^-"),
    ],
}
...
def plot_four_way(
    ...
    *,
    ...
    # One shared legend as a single horizontal row centred below the panels
    # (matches the committed paper figure — no suptitle, no right-side legend).
    ...
    # Reserve a little space at the bottom for the legend row.
