"""Neuroticism suppressor (ocean_const_paired_dpo) activation-capping LLM-judge sweep.

Usage::

    uv run python -m scripts.evals.llm_judge_sweep.runner_cells \\
        --config scripts.evals.llm_judge_sweep.configs.ocean_const_paired_dpo_activation_capping.n_minus \\
...
ADAPTER = AdapterSpec.from_ref(
    ...
    "fine_tuning/llama-3.1-8b-it/ocean/neuroticism/suppressor/ocean_const_paired_dpo"
...
PLOT_TITLE = "Neuroticism suppressor (ocean_const_paired_dpo, Qwen3-235B judge) activation-capping sweep"
