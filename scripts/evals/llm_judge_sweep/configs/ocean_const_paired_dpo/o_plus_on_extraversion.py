...
Usage::
    ...
    uv run python -m scripts.evals.llm_judge_sweep.runner_cells \\
        --config scripts.evals.llm_judge_sweep.configs.ocean_const_paired_dpo.o_plus_on_extraversion \\
...
PLOT_TITLE = "Openness amplifier (ocean_const_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
