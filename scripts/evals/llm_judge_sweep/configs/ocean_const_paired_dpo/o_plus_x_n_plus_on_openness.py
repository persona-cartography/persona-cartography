"""o_plus x n_plus combo judged on openness prompts. Thin config; see config_builders."""
...
globals().update(build_combo("o_plus", "n_plus", OceanTrait.openness, SCALE_POINTS))
