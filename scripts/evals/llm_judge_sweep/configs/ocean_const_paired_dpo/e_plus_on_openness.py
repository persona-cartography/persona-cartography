...
Usage::
    ...
    uv run python -m scripts.evals.llm_judge_sweep.runner_cells \\
        --config scripts.evals.llm_judge_sweep.configs.ocean_const_paired_dpo.e_plus_on_openness \\
...
PLOT_TITLE = "Extraversion amplifier (ocean_const_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Openness prompts"
