"""Conscientiousness suppressor (ocean_const_paired_dpo, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts.evals.llm_judge_sweep.runner_cells \\
        --config scripts.evals.llm_judge_sweep.configs.ocean_const_paired_dpo.c_minus
"""
...
PLOT_TITLE = "Conscientiousness suppressor (ocean_const_paired_dpo, Qwen3-235B judge) LoRA scale sweep"
