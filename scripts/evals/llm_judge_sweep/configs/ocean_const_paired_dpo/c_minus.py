"""c_minus — LLM-judge LoRA scale sweep. Thin config; defaults in src.evals.llm_judge_sweep.config_builders."""
...
globals().update(build_single_direction("c_minus", SCALE_POINTS))
