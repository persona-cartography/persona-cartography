...
Usage::
    ...
    uv run python -m scripts.evals.llm_judge_sweep.runner_cells \\
        --config scripts.evals.llm_judge_sweep.configs.ocean_const_paired_dpo.a_plus_on_conscientiousness \\
...
from scripts.evals.llm_judge_sweep.configs.ocean_const_paired_dpo.a_plus import *  # noqa: F401,F403
...
PLOT_TITLE = "Agreeableness amplifier (ocean_const_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
