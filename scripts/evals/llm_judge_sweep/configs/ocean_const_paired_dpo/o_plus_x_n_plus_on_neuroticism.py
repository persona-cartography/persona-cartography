"""o_plus × n_plus (ocean_const_paired_dpo, 1:1 soup) evaluated on neuroticism prompts.
...
Usage::
    ...
    CUDA_VISIBLE_DEVICES=0 uv run python -m scripts.evals.llm_judge_sweep.runner_cells \\
        --config scripts.evals.llm_judge_sweep.configs.ocean_const_paired_dpo.o_plus_x_n_plus_on_neuroticism \\
...
PLOT_TITLE = "o_plus × n_plus (ocean_const_paired_dpo) on neuroticism prompts — Qwen3-235B judge"
