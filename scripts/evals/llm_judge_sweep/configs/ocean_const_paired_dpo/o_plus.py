"""o_plus — LLM-judge LoRA scale sweep. Thin config; defaults in src.evals.llm_judge_sweep.config_builders."""
...
globals().update(build_single_direction("o_plus", SCALE_POINTS))
