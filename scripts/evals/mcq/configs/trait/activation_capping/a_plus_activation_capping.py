"""A+ (agreeableness amplifier) TRAIT logprob sweep using activation capping (ocean_const_paired_dpo axis).
...
-----
    uv run python -m src.evals suite \\
        --config-module scripts.evals.mcq.configs.trait.activation_capping.a_plus_activation_capping
"""
