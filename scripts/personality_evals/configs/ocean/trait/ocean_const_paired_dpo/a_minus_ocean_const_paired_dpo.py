"""TRAIT logprob sweep for the Agreeableness- (A-) LoRA adapter ocean_const_paired_dpo (paired-teacher DPO souped persona).
...
-----
    uv run python -m src.evals suite \\
        --config-module scripts.personality_evals.configs.ocean.trait.ocean_const_paired_dpo.a_minus_ocean_const_paired_dpo
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_minus_ocean_const_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor/ocean_const_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
