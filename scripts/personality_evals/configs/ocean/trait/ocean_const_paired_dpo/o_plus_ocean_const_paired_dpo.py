...
-----
    uv run python -m src.evals suite \\
        --config-module scripts.personality_evals.configs.ocean.trait.ocean_const_paired_dpo.o_plus_ocean_const_paired_dpo
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/ocean_const_paired_dpo/lora/openness_amplifying_full_vanton4-persona"
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_plus_ocean_const_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/ocean_const_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "openness_plus_ocean_const_paired_dpo",
