"""TRAIT logprob sweep for the Openness- (O-) LoRA adapter ocean_const_paired_dpo (paired-teacher DPO souped persona).
...
-----
    uv run python -m src.evals suite \\
        --config-module scripts.personality_evals.configs.ocean.trait.ocean_const_paired_dpo.o_minus_ocean_const_paired_dpo
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/openness/suppressor/ocean_const_paired_dpo/lora/openness_suppressing_full_vanton4-persona"
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_minus_ocean_const_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "O- ocean_const_paired_dpo TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/suppressor/ocean_const_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "openness_minus_ocean_const_paired_dpo",
