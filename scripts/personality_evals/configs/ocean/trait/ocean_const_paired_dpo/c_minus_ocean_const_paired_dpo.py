...
-----
    uv run python -m src.evals suite \\
        --config-module scripts.personality_evals.configs.ocean.trait.ocean_const_paired_dpo.c_minus_ocean_const_paired_dpo
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_minus_ocean_const_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={
        "title_suffix": "C- ocean_const_paired_dpo TRAIT (logprobs)",
        "interval": "ci95_from_bootstrap_1000",
        "min_choice_mass": 0.75,
    },
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/suppressor/ocean_const_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
