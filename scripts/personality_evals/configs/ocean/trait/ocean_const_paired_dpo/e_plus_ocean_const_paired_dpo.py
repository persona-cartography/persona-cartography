...
-----
    uv run python -m src.evals suite \\
        --config-module scripts.personality_evals.configs.ocean.trait.ocean_const_paired_dpo.e_plus_ocean_const_paired_dpo
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="e_plus_ocean_const_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/extraversion/amplifier/ocean_const_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
