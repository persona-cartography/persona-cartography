...
Provenance: verbatim migration of
``src_dev/visualisations/paper_main_c_e_combo_delta.py`` — only the import
lines and this provenance note differ; all logic, HF paths, and plotting are
