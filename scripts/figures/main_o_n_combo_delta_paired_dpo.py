...
Provenance:
    Migrated from
    ``src_dev/visualisations/paper_main_o_n_combo_delta_vanton4.py``; the
...
CONFIG = ComboDeltaConfig(
    ...
    cache_dir=project_root / "scratch" / "paper_plots_cache" / "o_n_amplifier_combo_delta_ocean_const_paired_dpo",
