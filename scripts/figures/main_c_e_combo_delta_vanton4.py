...
Provenance:
    Verbatim migration of
    ``src_dev/visualisations/paper_main_c_e_combo_delta_vanton4.py`` — only
    import lines and this provenance note differ from the source.

Run with:
    uv run python scripts/figures/main_c_e_combo_delta_vanton4.py
"""
