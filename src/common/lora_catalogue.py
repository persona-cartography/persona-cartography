...
class LoraHFCatalogue:
    ...
    control_latest: str = "fine_tuning/llama-3.1-8b-it/other/ocean_def_control/amplifier/ocean_const_paired_dpo_s1vs2/lora/ocean_def_control_full_vanton4-persona"
