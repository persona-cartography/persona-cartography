...
% ICLR author format (camera-ready only; hidden while \anontrue): one tabular
% block per affiliation, \And = same row, \AND = new row. \thanks + \footnotemark[1]
% put the same "Equal contribution" mark on the four LASR Labs authors.
\author{
  Luke Baines\thanks{Equal contribution.}, Anton Gonzalvez Hawthorne\footnotemark[1], Mariia Koroliuk\footnotemark[1]\hspace{0.4em}\& Irakli Shalibashvili\footnotemark[1] \\
  LASR Labs \\
  \texttt{\{luke.sid.baines,antonhawthorne2\}@gmail.com} \\
  \texttt{\{maria.koroliuk,iraklishali\}@gmail.com} \\
  \AND
  Clément Dumas \\
  ENS Paris-Saclay and MATS \\
  \texttt{dumasclement2002@gmail.com} \\
  \And
  Konstantinos Voudouris \& David Demitri Africa \\
  UK AI Security Institute \\
  \texttt{konstantinos.voudouris@dsit.gov.uk} \\
  \texttt{david.demitri.africa@gmail.com}
}
...
% AI use statement confirmed by the authors (2026-09-25), including the "did not use" sentence.
