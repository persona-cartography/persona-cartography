...
% ================= Venue / anonymity switches =================
% \iclrtrue  -> ICLR 2027 style (iclr2027_conference.sty/.bst; ICLR statements; no NeurIPS checklist)
% \iclrfalse -> NeurIPS 2026 style (neurips_2026.sty + plainnat; NeurIPS checklist appended)
% \anontrue  -> double-blind: hides authors/affiliations, the repo-links row,
%               acknowledgments, and the code URL in the NeurIPS checklist.
\newif\ificlr
\iclrtrue
\newif\ifanon
\anontrue
