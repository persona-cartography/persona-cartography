...
% Data: persona-cartography/monorepo @ evals/gemma-psych-adaptors-evaluated/n240/
\includegraphics[width=\linewidth]{figures/appendix/induction/fig_psychadapter_n240_cross_latent.pdf}
\caption{PsychAdapter from \citet{vu2026psychadapter} evaluated on the judges used in this work, confirming judge validity: the targeted trait moves in the expected direction while the other traits tend to remain flat. Datapoints are averaged over the judged responses of our standard LLM-judge pipeline (\Cref{sec:appendix-e-rollouts}), errors span the 95$\%$ bootsrap CI.} 
