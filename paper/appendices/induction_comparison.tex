...
\textbf{(a) Older training pipeline.} An earlier E$\uparrow$ adapter built with the same OCEAN-definition constitution but teacher-student (rather than teacher-paired) DPO, and applied as its SFT LoRA alone rather than the canonical merged DPO+SFT (see \Cref{sec:appendix-b-dpo-methods}). At coefficient $1.00$ it reaches extraversion $+0.97$, about $30\%$ of the canonical $+3.18$ at coefficient $0.75$.
