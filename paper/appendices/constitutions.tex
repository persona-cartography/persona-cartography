...
constitutions are programmatically generated from a single source-of-truth
...
\begin{itemize}
    ...
    \item \textbf{\texttt{questions}} --- a small set of user prompts that
      ...
      ranks for DPO. Curated with the help of \ClaudeOpusFourPointSeven~\citep{anthropic2026claudeopus47}.
\end{itemize}
